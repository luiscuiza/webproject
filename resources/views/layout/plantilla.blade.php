        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            <a href="/producto" id="menu-producto" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 \
                            text-sm font-medium">Productos</a>
                            <a href="/categoria" id="menu-categoria" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 \
                            text-sm font-medium">Categorias</a>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    <button type="button" class="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 \
                    ...
                    <div class="relative ml-3">
                        ...
                        focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" id="user-menu" tabindex="-1">
